  ...
  return (
    ...
    <div className="hero-content text-center">
      <div className="max-w-xl">
        ...
        Welcome to Silox, where fashion meets convenience. 
        Explore our curated selection of shoes, clothes, and accessories to express your unique style effortlessly. 
        Shop now for the latest trends and timeless classics!
        </p>
